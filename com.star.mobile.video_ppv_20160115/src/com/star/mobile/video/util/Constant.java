...
//	public static final int CURRENT_VERSION = DEVELOPMENT_VERSION;
	...
	public static String getProgramdetailUrl(){
		return SERVER_URL+"/ppvs/program/";
	}
	...
	public static String getEpgListUrl(){
		return SERVER_URL+"/programs/ppv";
	}
