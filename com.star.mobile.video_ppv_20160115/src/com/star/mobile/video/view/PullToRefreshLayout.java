...
import com.star.mobile.video.util.Pullable;
 ...
 * 
 * @author Lee @version1.0 2015/08/31
 */
...
//				pullUpView.clearAnimation();
	...
	public void refreshFinish(int refreshResult) {
		...
		case NOMOREDATA:
			//没有更多数据
			refreshStateImageView.setVisibility(View.VISIBLE);
			refreshStateTextView.setText(R.string.load_no_data);
			refreshStateImageView.setBackgroundResource(R.drawable.refresh_succeed);
			break;
		}
		// 刷新结果停留1秒
...
//			loadStateImageView.setBackgroundResource(R.drawable.load_failed);
		...
		case NOMOREDATA:
			//没有更多数据
			loadStateImageView.setVisibility(View.VISIBLE);
			if (mLoadDoneText != null ) {
				loadStateTextView.setText(mLoadDoneText);
			}else {
				loadStateTextView.setText(R.string.load_no_data);
			}
			loadStateImageView.setBackgroundResource(R.drawable.load_succeed);
			break;
		}
	 ...
	 * @param content
	 */
	public void setLoadDoneText(String content){
		this.mLoadDoneText = content;
	}
