...
public class BaseEpgListView extends LinearLayout implements OnTouchListener{
	...
	public BaseEpgListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public BaseEpgListView(Context context) {
		super(context);
	}
