...
public class VideoEndView extends RelativeLayout implements OnClickListener {
	...
	private void initView() {
		...
		if(FunctionService.doHideFuncation(FunctionType.RechargeCard)) {
			mVideoEndRecharge.setVisibility(View.INVISIBLE);
		} else {
			mVideoEndRecharge.setVisibility(View.VISIBLE);
		}
	}
	...
	private void initData() {
		...
		if (mChannel != null && channelPackage != null && isNoneBouquetChannel()) {
			promptCotent = mContext.getString(R.string.video_end_change_bouquet_prompt, mChannel.getName(), channelPackage.getName());
		} else {
			promptCotent = mContext.getString(R.string.video_end_change_bouquet_none);
		}
