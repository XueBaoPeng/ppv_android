...
//		initData();
	...
	private void initView() {
		// mView.findViewById(R.id.smar_card_info_rl).setOnClickListener(this);
	...
	public void setCardMoney(Double money) {
		mSmartCardBalance.setText(getResources().getString(R.string.balance)+":"+SharedPreferencesUtil.getCurrencSymbol(getActivity()) + money);
	}
