...
public class SmartCardService extends AbstractService {
	...
	public void getAllNetSmartCardInfos(OnListResultListener<SmartCardInfoVO> listener) {
		doGet(Constant.getSmartCardNoUrl(), SmartCardInfoVO.class, LoadMode.NET, listener);
	}
