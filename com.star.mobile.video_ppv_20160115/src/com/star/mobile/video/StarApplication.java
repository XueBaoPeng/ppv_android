...
public class StarApplication extends Application {
	...
	private ABTestSharedPre sharedPre;
...
//		SSLUtil.disableCertificateValidation();
        ...
        sharedPre = new ABTestSharedPre(this);
        if(sharedPre.getABTest().equals("")){
			loadAorB();	
		}
	}
	private void loadAorB(){
		...
		int num = r.nextInt(2) + 1;
		 if(num == 1) {        
			sharedPre.setABTest("A");
			GA.sendCustomDimension(2, "A");
        } else if(num == 2) {  
        	sharedPre.setABTest("B");
        	GA.sendCustomDimension(2, "B");
        }
	}
