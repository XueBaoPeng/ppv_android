...
public class VideoSeekBar extends SeekBar{
	...
	public VideoSeekBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		mView = LayoutInflater.from(context).inflate(R.layout.view_video_play_time, null);
		videoSeekTime = (TextView) mView.findViewById(R.id.tv_video_seektime);
