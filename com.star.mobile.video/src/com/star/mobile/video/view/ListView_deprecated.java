 ...
 *
 */
public class ListView_deprecated extends android.widget.ListView{
	...
	public ListView_deprecated(Context context) {
		super(context);
		init_();
	}
	
	public ListView_deprecated(Context context, AttributeSet attrs) {
       super(context, attrs);
       init_();
    }

    public ListView_deprecated(Context context, AttributeSet attrs, int defStyle) {
