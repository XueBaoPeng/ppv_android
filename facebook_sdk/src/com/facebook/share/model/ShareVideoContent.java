...
public final class ShareVideoContent
    ...
    public static final class Builder extends ShareContent.Builder<ShareVideoContent, Builder> {
         ...
         * @return The builder.
         */
        public Builder setContentTitle(  final String contentTitle) {
         ...
         * @return The builder.
         */
        public Builder setPreviewPhoto(  final SharePhoto previewPhoto) {
            this.previewPhoto = (
                    previewPhoto == null ?
                    null :
         ...
         * @return The builder.
         */
        public Builder setVideo(  final ShareVideo video) {
            if (video == null) {
                return this;
            }
