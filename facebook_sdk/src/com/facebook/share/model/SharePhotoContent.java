...
public final class SharePhotoContent
    ...
    public static class Builder extends ShareContent.Builder<SharePhotoContent, Builder> {
         ...
         * @return The builder.
         */
        public Builder addPhoto(  final SharePhoto photo) {
            if (photo != null) {
         ...
         * @return The builder.
         */
        public Builder addPhotos(  final List<SharePhoto> photos) {
            if (photos != null) {
         ...
         * @return The builder.
         */
        public Builder setPhotos(  final List<SharePhoto> photos) {
            this.photos.clear();
