...
public abstract class ShareOpenGraphValueContainer
    ...
    public abstract static class Builder
         ...
         * @return The builder.
         */
        public E putBooleanArray(final String key,   final boolean[] value) {
         ...
         * @return The builder.
         */
        public E putDoubleArray(final String key,   final double[] value) {
         ...
         * @return The builder.
         */
        public E putIntArray(final String key,   final int[] value) {
         ...
         * @return The builder.
         */
        public E putLongArray(final String key,   final long[] value) {
         ...
         * @return The builder.
         */
        public E putObject(final String key,   final ShareOpenGraphObject value) {
        ...
        public E putObjectArrayList(
                final String key,
                  final ArrayList<ShareOpenGraphObject> value) {
         ...
         * @return The builder.
         */
        public E putPhoto(final String key,   final SharePhoto value) {
            this.bundle.putParcelable(key, value);
            return (E)this;
        }
         ...
         * @return The builder.
         */
        public E putPhotoArrayList(final String key,   final ArrayList<SharePhoto> value) {
            this.bundle.putParcelableArrayList(key, value);
            return (E) this;
        }
         ...
         * @return The builder.
         */
        public E putString(final String key,   final String value) {
         ...
         * @return The builder.
         */
        public E putStringArrayList(final String key,   final ArrayList<String> value) {
